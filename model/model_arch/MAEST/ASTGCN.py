...
class ASTGCN(nn.Module):
    ...
    def __init__(self, nb_block, K, nb_chev_filter, nb_time_filter, time_strides, A, len_input,
                 num_for_predict, num_nodes, DEVICE, dim_in, dim_out):
        '''
        :param nb_block:
        :param in_channels:
        :param K:
        ...
        self.pre_liner = nn.Linear(in_features=3,
                                   out_features=dim_in // 2)
    ...
    def forward(self, x, pre_trained_feature):
        '''
        ...
        x = pre_trained_feature.permute(0, 2, 3, 1)
